...
test("exports the maximum supported cell count", () => { expect(maxColumns).toBe(1024); });
test("clamps oversized requests to 1024 Unicode columns", () => { expect(artSize(512, 512, 9999)).toEqual({ dotsWidth: 2048, dotsHeight: 2048, rows: 512 }); });
