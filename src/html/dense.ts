import { Css } from "../../vendor/unicode-grid/src/html/css.ts";
...
export const denseHtml = (source: string | Art, title = "Unicode Art", thickness = 0): string => {
