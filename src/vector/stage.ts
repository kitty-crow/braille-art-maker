...
export const vectorStage = (pixels: Pixels, cfg: VecCfg = {}): VecStage => {
  const result = vectorise(pixels, { colours: cfg.colours ?? 64, alphaLevels: cfg.alphaLevels ?? 16, alphaThreshold: 0, crop: false, precision: 4, iterations: 12, sampleLimit: 12000, seed: 39, title: "Braille Art Maker vector stage" });
